            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="admin/product/edit/<?php echo e($product->Product_ID); ?>" method="POST">
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
                                             <?php if($product->Product_Thumbnail != ''): ?>
                                                <img src="<?php echo e($product->Product_Thumbnail); ?>">
                                             <?php endif; ?>
					 ...
					 <div class="form-group">
						...
						<input class="form-control" name="Product_PriceMarket" placeholder="Nhập giá bán" value="<?php echo e($product->Product_PriceMarket); ?>"/>
					</div>
					<div class="form-group">
						<label>Giá bán <span class="text-danger">*</span></label>
						<input class="form-control" name="Product_Price" placeholder="Nhập giá bán"  value="<?php echo e($product->Product_Price); ?>"/>
					</div>
					<div class="form-group">
						<label>Mô tả <span class="text-danger">*</span></label>
						<textarea class="form-control" name="Product_Description" rows="3" value=""><?php echo e($product->Product_Description); ?></textarea>
					</div>
					<div class="form-group">
						<label>Nội dung giới thiệu</label>
						<textarea id="summernote" class="form-control" rows="3" name="Product_Content" value=""><?php echo e($product->Product_Content); ?></textarea>
					</div>
					<div class="form-group">
