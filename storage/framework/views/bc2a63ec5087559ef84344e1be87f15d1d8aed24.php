                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<?php $__currentLoopData = $product_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="odd gradeX" align="center">
                                ...
                                <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="quanly/sanpham/xoa/<?php echo e($r->Product_ID); ?>"> Xóa</a></td>
                                <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="quanly/sanpham/sua/<?php echo e($r->Product_ID); ?>">Sửa</a></td>
                            </tr>
